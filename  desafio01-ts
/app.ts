...
const peopleAccount: PeopleAccount = new PeopleAccount(1, 'Isaias', 10, true);
...
const inactivePeopleAccount: PeopleAccount = new PeopleAccount(1, 'Teste01', 10, false);
const inactiveCompanyAccount: CompanyAccount = new CompanyAccount('DIO 2', 20, false);
const inactivespecialAccount: SpecialAccount = new SpecialAccount('DIO teste 2', 40, false);
